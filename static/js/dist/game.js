...
class ChatField {
    constructor(playground) {
        ...
        this.$history = $(`<div class="ac-game-chat-field-history">历史聊天记录</div>`);
        this.$input = $(`<input type="txet" class="ac-game-chat-field-input">`);
...
class MultiPlayerSocket {
    constructor(playground) {
        ...
        this.ws = new WebSocket("wss://victor-gx.com.cn/wss/multiplayer/");
